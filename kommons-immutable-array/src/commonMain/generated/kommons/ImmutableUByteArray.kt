 ...
 */
@ExperimentalUnsignedTypes
public fun ImmutableUByteArray(size: Int): ImmutableUByteArray {
    return ImmutableUByteArray(UByteArray(size))
}
...
/** Creates a new immutable array of unsigned bytes which contains the given [elements]. */
@ExperimentalUnsignedTypes
